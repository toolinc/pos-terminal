...
class SideTicket extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            openAvatar: false,
...
SideTicket.defaultProps = {
    bgColor: "blue"
};

SideTicket.propTypes = {
...
export default withStyles(sidebarStyle)(SideTicket);
